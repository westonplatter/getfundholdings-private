...
class SummaryTickerSchema(pa.DataFrameModel):
    ...
    latest_report_date: Series[str] = pa.Field(description="Latest N-PORT report date (YYYYMMDD format)")
    latest_timestamp: Series[str] = pa.Field(description="Latest file timestamp (YYYYMMDD_HHMMSS format)")
    latest_file: Series[str] = pa.Field(description="Latest enriched holdings filename")
    
    # Processing metadata
    data_updated: Series[str] = pa.Field(description="ISO timestamp when summary was generated")
